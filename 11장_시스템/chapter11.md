...
<pre> 복잡성은 죽음이다. 개발자에게서 생기를 앗아가며, 제품을 계획하고 제작하고 테스트하기 어렵게 만든다."
...
```swift
// FIXME: 어떤 경우에도 nil를 반환하지않는다..라는게 확신이 없어서 추가를 못했었어요 ㅜㅜ
...
과연 이 시점에서 어떤 객체로 사용할지 알 수나 있을까? 현실적으로 한 객체 유형이 모든 문맥에 적합할 가능성이 있을까? <br>
